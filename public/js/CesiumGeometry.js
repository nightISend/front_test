(function webpackUniversalModuleDefinition(root, factory) {
    if (typeof exports === 'object' && typeof module === 'object')
        module.exports = factory(require("SuperMap3D"));
    else if (typeof define === 'function' && define.amd)
        define(["SuperMap3D"], factory);
    else if (typeof exports === 'object')
        exports["CesiumGeometry"] = factory(require("SuperMap3D"));
    else
        root["CesiumGeometry"] = factory(root["SuperMap3D"]);
    ...
    ([
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var BoundingSphere = _Cesium2.BoundingSphere;
            var Cartesian3 = _Cesium2.Cartesian3;
            var Color = _Cesium2.Color;
            var combine = _Cesium2.combine;
            var ComponentDatatype = _Cesium2.ComponentDatatype;
            var defaultValue = _Cesium2.defaultValue;
            var defined = _Cesium2.defined;
            var defineProperties = _Cesium2.defineProperties;
            var destroyObject = _Cesium2.destroyObject;
            var DeveloperError = _Cesium2.DeveloperError;
            var Matrix4 = _Cesium2.Matrix4;
            var PrimitiveType = _Cesium2.PrimitiveType;
            var Buffer = _Cesium2.Buffer;
            var BufferUsage = _Cesium2.BufferUsage;
            var DrawCommand = _Cesium2.DrawCommand;
            var Pass = _Cesium2.Pass;
            var RenderState = _Cesium2.RenderState;
            var ShaderProgram = _Cesium2.ShaderProgram;
            var ShaderSource = _Cesium2.ShaderSource;
            var VertexArray = _Cesium2.VertexArray;
            var BlendingState = _Cesium2.BlendingState;
            var CullFace = _Cesium2.CullFace;
            var Material = _Cesium2.Material;
            var SceneMode = _Cesium2.SceneMode;
            var VertexFormat = _Cesium2.VertexFormat;
            var CesiumMath = _Cesium2.Math;
            var Matrix3 = _Cesium2.Matrix3;
            var Matrix4 = _Cesium2.Matrix4;
            var JulianDate = _Cesium2.JulianDate;

            var BoxGeometry = _Cesium2.BoxGeometry;
            var EllipsoidGeometry = _Cesium2.EllipsoidGeometry;
            ...
            function RectangularSensorPrimitive(options) {
                 ...
                 * 是否显示扫描面
                 */
                this._showScanPlane = defaultValue(options.showScanPlane, true);
                this._showScanPlaneChanged = true;
                /**
                 * 扫描面颜色
                 */
                ...
                Object.defineProperties(RectangularSensorPrimitive.prototype, {
                    showScanPlane : {
                        get : function(){
                            return this._showScanPlane;
                        },
                        set : function(v){
                            if(this._showScanPlane === v){
                                return;
                            }
                            this._showScanPlane = v;
                            this._showScanPlaneChanged = true;
                        }
                    }
                })
            ...
            RectangularSensorPrimitive.prototype.update = function (frameState) {
                ...
                if (this._xHalfAngle !== xHalfAngle || this._yHalfAngle !== yHalfAngle || this._showScanPlaneChanged) {
                ...
                if (this._material !== material || this._showScanPlaneChanged) {
                    this._material = material;
                    createRS = true;
                    createSP = true;
                    this._showScanPlaneChanged = false;
                }
                ...
                if (this.showScanPlane) {
                    ...
                    //增加判断，适配Cesium1.54以后的，防止time与this._time一致并且没有变化
                    if (timeDiff == 0) {
                        timeDiff = JulianDate.secondsDifference(JulianDate.now(), this._time);
                    }
                    ...
                    if (this.scanPlaneMode == 'horizontal') {
                        ...
                        _Cesium2.Matrix3.fromRotationX(this._scanePlaneYHalfAngle, matrix3Scratch);
                    } else {
                        ...
                        _Cesium2.Matrix3.fromRotationY(this._scanePlaneXHalfAngle, matrix3Scratch);
                    }

                    _Cesium2.Matrix4.multiplyByMatrix3(this.modelMatrix, matrix3Scratch, this._computedScanPlaneModelMatrix);
            ...
            function computeSectorPositions(primitive, unitPosition) {
                ...
                positions.push(zoy.map(function (p) {
                    return Matrix3.multiplyByVector(matrix3, p, new _Cesium2.Cartesian3());
                }));
            ...
            function createSectorLineVertexArray(context, positions) {
                ...
                var normalData = new Float32Array(3 * 3 * planeLength);
                var k = 0;
                for (var i = 0, len = positions.length; i < len; i++) {
                    var planePositions = positions[i];
                    vertices[k++] = 0.0;
            ...
            function createDomeVertexArray(context) {
                var geometry = _Cesium2.EllipsoidGeometry.createGeometry(new _Cesium2.EllipsoidGeometry({
            ...
            function createDomeLineVertexArray(context) {
                var geometry = _Cesium2.EllipsoidOutlineGeometry.createGeometry(new _Cesium2.EllipsoidOutlineGeometry({
                    vertexFormat: VertexFormat.POSITION_ONLY,
                    stackPartitions: 32,
                    slicePartitions: 32
                }));
            ...
            function createCommand(primitive, frontCommand, backCommand, frontFaceRS, backFaceRS, sp, va, uniforms, modelMatrix, translucent, pass, isLine) {
                ...
                if (isLine) {
                    frontCommand.uniformMap.u_geoType = function () {
                        return 1;
                    };
                }
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var BoundingSphere = _Cesium2.BoundingSphere,
                ...
                GeometryAttributes = _Cesium2.GeometryAttributes,
                ...
                IndexDatatype = _Cesium2.IndexDatatype,
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var defaultValue = _Cesium2.defaultValue,
                defined = _Cesium2.defined,
                defineProperties = _Cesium2.defineProperties,
                DeveloperError = _Cesium2.DeveloperError,
                Event = _Cesium2.Event,
                createMaterialPropertyDescriptor = _Cesium2.createMaterialPropertyDescriptor,
                createPropertyDescriptor = _Cesium2.createPropertyDescriptor;
            ...
            Object.defineProperties(ConicArcSensorGraphics.prototype, {
                /**
        ...
        (function (module, exports, __webpack_require__) {
            ...
            _Cesium2.getLinkedPointList = _getLinkedPointList.getLinkedPointList;
        ...
        (function (module, exports, __webpack_require__) {
            ...
            //conicSensor
            _Cesium2.RectangularSensorPrimitive = _RectangularSensorPrimitive.RectangularSensorPrimitive;
            _Cesium2.RectangularSensorGraphics = _RectangularSensorGraphics.RectangularSensorGraphics;
            _Cesium2.RectangularSensorVisualizer = _RectangularSensorVisualizer.RectangularSensorVisualizer;

            //conicSensor
            _Cesium2.ConicArcSensorGeometry = _ConicArcSensorGeometry.ConicArcSensorGeometry;
            _Cesium2.ConicArcSensorOutlineGeometry = _ConicArcSensorOutlineGeometry.ConicArcSensorOutlineGeometry;
            _Cesium2.ConicArcSensorGraphics = _ConicArcSensorGraphics.ConicArcSensorGraphics;
            _Cesium2.ConicArcSensorCollection = _ConicArcSensorCollection.ConicArcSensorCollection;

            var DataSourceDisplay = _Cesium2.DataSourceDisplay;
            ...
            DataSourceDisplay.defaultVisualizersCallback = function (scene, entityCluster, dataSource) {
                ...
                return array == null ? false : array.concat([new _RectangularSensorVisualizer.RectangularSensorVisualizer(scene, entities)]);
            };
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var defineProperties = _Cesium2.defineProperties;
            var DeveloperError = _Cesium2.DeveloperError;
            var Event = _Cesium2.Event;
            var createMaterialPropertyDescriptor = _Cesium2.createMaterialPropertyDescriptor;
            var createPropertyDescriptor = _Cesium2.createPropertyDescriptor;
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var AssociativeArray = _Cesium2.AssociativeArray;
            var Cartesian3 = _Cesium2.Cartesian3;
            var Color = _Cesium2.Color;
            var defined = _Cesium2.defined;
            var destroyObject = _Cesium2.destroyObject;
            ...
            var Matrix3 = _Cesium2.Matrix3;
            var Matrix4 = _Cesium2.Matrix4;
            var Quaternion = _Cesium2.Quaternion;
            var MaterialProperty = _Cesium2.MaterialProperty;
            var Property = _Cesium2.Property;
            ...
            RectangularSensorVisualizer.prototype.update = function (time) {
                ...
                for (var i = 0, len = entities.length; i < len; i++) {
                    ...
                    if (defined(gaze)) {
                        ...
                        var rotate = Cartesian3.angleBetween(_Cesium2.Cartesian3.UNIT_Z, diffVector);
                        var cross = Cartesian3.cross(_Cesium2.Cartesian3.UNIT_Z, diffVector, diffVectorScratch);
                        ...
                        if (!Cartesian3.equals(position, data.position) || !Quaternion.equals(orientation, data.orientation)) {
                            if (defined(orientation)) {
                                ...
                                primitive.modelMatrix = _Cesium2.Transforms.eastNorthUpToFixedFrame(position);
                                data.position = Cartesian3.clone(position, data.position);
                            }
                        }
                    }
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var defaultValue = _Cesium2.defaultValue;
            var defined = _Cesium2.defined;
            var Viewer = _Cesium2.Viewer;
            var Transforms = _Cesium2.Transforms;
            var DeveloperError = _Cesium2.DeveloperError;
            var ColorGeometryInstanceAttribute = _Cesium2.ColorGeometryInstanceAttribute;
            var Color = _Cesium2.Color;
            var Primitive = _Cesium2.Primitive;
            var PerInstanceColorAppearance = _Cesium2.PerInstanceColorAppearance;
            var Cartesian3 = _Cesium2.Cartesian3;
            var VertexFormat = _Cesium2.VertexFormat;
            var Quaternion = _Cesium2.Quaternion;
            var Matrix3 = _Cesium2.Matrix3;
            ...
            var Property = _Cesium2.Property;
            var Event = _Cesium2.Event;
            var DistanceDisplayCondition = _Cesium2.DistanceDisplayCondition;
            var DistanceDisplayConditionGeometryInstanceAttribute = _Cesium2.DistanceDisplayConditionGeometryInstanceAttribute;
            ...
            ConicArcSensorCollection.prototype.update = function () {
                ...
                for (var i = 0, len = conicArcSensorCollection.length; i < len; i++) {
                    ...
                    if (defined(gaze)) {
                        ...
                        radius = 1;
                        modelMatrix = Matrix4.fromRotationTranslation(_Cesium2.Matrix3.multiplyByScalar(Matrix3.fromQuaternion(orientation, matrix3Scratch), distance, matrix3Scratch), position, matrix4Scratch);
                    } else {
                    ...
                    if (!defined(geometry)) {
                        ...
                        conic = new _ConicArcSensorGeometry.ConicArcSensorGeometry({
                            vertexFormat: _Cesium2.VertexFormat.POSITION_AND_NORMAL,
                            angle: angle,
                            radius: radius,
                    ...
                    var instance = new _Cesium2.GeometryInstance({
                        geometry: geometry,
                        modelMatrix: modelMatrix,
                        attributes: {
                            color: _Cesium2.ColorGeometryInstanceAttribute.fromColor(color)
                    ...
                    if (outline) {
                        ...
                        if (!defined(outlineGeometry)) {
                            ...
                            conicOutline = new _ConicArcSensorOutlineGeometry.ConicArcSensorOutlineGeometry({
                                vertexFormat: _Cesium2.VertexFormat.POSITION_ONLY,
                                angle: angle,
                                radius: radius
                            });
                        ...
                        var instance = new _Cesium2.GeometryInstance({
                            ...
                            modelMatrix: modelMatrix,
                            attributes: {
                                color: _Cesium2.ColorGeometryInstanceAttribute.fromColor(outlineColor)
                                //distanceDisplayCondition: distanceDisplayConditionAttribute
                            }
                        });
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var Entity = _Cesium2.Entity;
            var Event = _Cesium2.Event;
            var ConstantPositionProperty = _Cesium2.ConstantPositionProperty;
            var createPropertyDescriptor = _Cesium2.createPropertyDescriptor;
            var DistanceDisplayCondition = _Cesium2.DistanceDisplayCondition;
            var DistanceDisplayConditionGeometryInstanceAttribute = _Cesium2.DistanceDisplayConditionGeometryInstanceAttribute;
        ...
        (function (module, exports, __webpack_require__) {
            ...
            _Cesium2.PolylineAttackLinkMaterialProperty = _PolylineAttackLinkMaterialProperty.PolylineAttackLinkMaterialProperty;
            _Cesium2.PolylineArrowLinkMaterialProperty = _PolylineArrowLinkMaterialProperty.PolylineArrowLinkMaterialProperty;
            _Cesium2.PolylineGlowLinkMaterialProperty = _PolylineGlowLinkMaterialProperty.PolylineGlowLinkMaterialProperty;
            _Cesium2.PolylinePulseLinkMaterialProperty = _PolylinePulseLinkMaterialProperty.PolylinePulseLinkMaterialProperty;
            _Cesium2.PolylineTrailLinkMaterialProperty = _PolylineTrailLinkMaterialProperty.PolylineTrailLinkMaterialProperty;
            _Cesium2.ElliposidFadeMaterialProperty = _ElliposidFadeMaterialProperty.ElliposidFadeMaterialProperty;
        ...
        (function (module, exports, __webpack_require__) {
            ...
            Object.defineProperties(PolylineArrowLinkMaterialProperty.prototype, {
                /**
                 * Gets a value indicating if this property is constant.  A property is considered
                 * constant if getValue always returns the same result for the current definition.
                 * @memberof PolylineGlowMaterialProperty.prototype
        ...
        (function (module, exports, __webpack_require__) {
            ...
            Object.defineProperties(PolylineGlowLinkMaterialProperty.prototype, {
                /**
                 * Gets a value indicating if this property is constant.  A property is considered
                 * constant if getValue always returns the same result for the current definition.
                 * @memberof PolylineGlowMaterialProperty.prototype
        ...
        (function (module, exports, __webpack_require__) {
            ...
            Object.defineProperties(PolylinePulseLinkMaterialProperty.prototype, {
                /**
                 * Gets a value indicating if this property is constant.  A property is considered
                 * constant if getValue always returns the same result for the current definition.
                 * @memberof PolylineGlowMaterialProperty.prototype
        ...
        (function (module, exports, __webpack_require__) {
            ...
            function getLinkedPointList(startPoint, endPoint, angularityFactor, numOfSingleLine) {
                ...
                var startPosition = _Cesium2.Cartographic.fromCartesian(startPoint);
                var endPosition = _Cesium2.Cartographic.fromCartesian(endPoint);
                ...
                //var dist = SuperMap3D.Cartesian3.distance(startPoint, endPoint);
                var angularity = dist * angularityFactor;

                var startVec = _Cesium2.Cartesian3.clone(startPoint);
                var endVec = _Cesium2.Cartesian3.clone(endPoint);

                var startLength = _Cesium2.Cartesian3.distance(startVec, _Cesium2.Cartesian3.ZERO);
                var endLength = _Cesium2.Cartesian3.distance(endVec, _Cesium2.Cartesian3.ZERO);

                _Cesium2.Cartesian3.normalize(startVec, startVec);
                _Cesium2.Cartesian3.normalize(endVec, endVec);

                if (_Cesium2.Cartesian3.distance(startVec, endVec) == 0) {
                    return result;
                }

                //var cosOmega = SuperMap3D.Cartesian3.dot(startVec, endVec);
                //var omega = Math.acos(cosOmega);

                var omega = _Cesium2.Cartesian3.angleBetween(startVec, endVec);
                ...
                for (var i = 1; i < numOfSingleLine - 1; i++) {
                    ...
                    var startScalarVec = _Cesium2.Cartesian3.multiplyByScalar(startVec, startScalar, new _Cesium2.Cartesian3());
                    var endScalarVec = _Cesium2.Cartesian3.multiplyByScalar(endVec, endScalar, new _Cesium2.Cartesian3());

                    var centerVec = _Cesium2.Cartesian3.add(startScalarVec, endScalarVec, new _Cesium2.Cartesian3());

                    var ht = t * Math.PI;
                    var centerLength = startLength * invT + endLength * t + Math.sin(ht) * angularity;
                    centerVec = _Cesium2.Cartesian3.multiplyByScalar(centerVec, centerLength, centerVec);
