(function () {
  /*
      ...
      trailImage 贴图地址
  */
  function ArrawWallMaterialProperty(options) {
  ...
  Object.defineProperties(ArrawWallMaterialProperty.prototype, {
    isConstant: {
      get: function () {
        return false;
      }
  ...
  ArrawWallMaterialProperty.prototype.getType = function (time) {
    return MaterialType;
  };
  
  ArrawWallMaterialProperty.prototype.getValue = function (time, result) {
  ...
  ArrawWallMaterialProperty.prototype.equals = function (other) {
    return this === other ||
      (other instanceof ArrawWallMaterialProperty
  ...
  SuperMap3D.ArrawWallMaterialProperty = ArrawWallMaterialProperty;
})();
